...
import PingMeVerticalNavExpansionPanel from './PingMeVerticalNavExpansionPanel'
...
const PingMeVerticalNav = ({ items }) => {
    ...
    const renderLevels = (data) => {
        return data.map((item, index) => {
            ...
            if (item.children) {
                return (
                    <PingMeVerticalNavExpansionPanel
                        mode={mode}
                        item={item}
                        key={index}
                    >
...
export default React.memo(PingMeVerticalNav)
